        ...
        <>
          ...
          <div className="dash-kpis">
            <div className="dash-kpi">
              ...
              <div>
                <div className="dash-kpi-value">8</div>
            ...
            <div className="dash-kpi">
              ...
              <div>
                <div className="dash-kpi-value">3</div>
            ...
            <div className="dash-kpi">
              ...
              <div>
                <div className="dash-kpi-value">$6,510</div>
            ...
            <div className="dash-panel">
              <div className="dash-panel-header">
                <h3 className="dash-panel-title">
                  Needs Attention
                  <span className="dash-panel-count attention">{mockAttentionItems.length}</span>
                </h3>
            ...
            <div className="dash-panel full-width">
              <div className="dash-panel-header">
                <h3 className="dash-panel-title">
                  ...
                  <span className="dash-panel-count activity">{mockActivityItems.length}</span>
                </h3>
