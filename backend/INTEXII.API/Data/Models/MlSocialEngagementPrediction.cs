...
{
    [Column("supporter_id")] public long SupporterId { get; set; }
    ...
    [Column("donation_frequency")] public long? DonationFrequency { get; set; }
    [Column("donation_value_sum")] public double? DonationValueSum { get; set; }
    [Column("referral_linked_donations")] public long? ReferralLinkedDonations { get; set; }
